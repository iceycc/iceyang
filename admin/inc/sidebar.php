...
<div class="aside">
  ...
  <ul class="nav">
    ...
    <?php $is_post_page = in_array($current_page, array('nav-menus', 'slides', 'settings')); ?>
    <li<?php echo $is_post_page ? ' class="active"' : '' ?>>
      <a href="#menu-settings" class="collapsed" data-toggle="collapse">
        <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
      </a>
      <ul id="menu-settings" class="collapse<?php echo $is_post_page ? ' in' : '' ?>">
        <li<?php echo $current_page === 'posts' ? ' class="active"' : '' ?>><a href="nav-menus.php">导航菜单</a></li>
        <li<?php echo $current_page === 'posts' ? ' class="active"' : '' ?>><a href="slides.php">图片轮播</a></li>
        <li<?php echo $current_page === 'posts' ? ' class="active"' : '' ?>><a href="settings.php">网站设置</a></li>
      </ul>
    </li>
  </ul>
</div>
